...
/**
 * @author [Iga Noviyanti R] on 24/01/2021 at 7:16.
 */
class ListMakananAdapter(private val images: MutableList<Int> = mutableListOf<Int>()) : RecyclerView.Adapter<ListMakananAdapter.MyViewHolder>() {
