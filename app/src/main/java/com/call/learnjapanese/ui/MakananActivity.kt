...
class MakananActivity : AppCompatActivity() {
    ...
    private val audionMinumanJp = mutableListOf(R.raw.minuman_air_id, R.raw.minuman_kopi_id, R.raw.minuman_teh_jp, R.raw.minuman_juice_jp, R.raw.minuman_susu_jp)
